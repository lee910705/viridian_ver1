(function (angular) {
    ...
    app.controller('DashboardCtrl', function ($scope, $q, $firebaseObject) {
        ...
        */
        ...
        console.log("Before grabbing data");
        ...
        ref.on("value", function (snapshot) {
            ...
            $q.all(objectHeatMap).then(function () {
                ...
                */
                ...
                var svg = d3.select("body").select("#dashboardSvg")
                ...
                */
                ...
                // write a new value for a phase in the sankey chart to firebase
                ...
                function getSankeyDataAndRender(){
                    ...
                    phasesRef.on('value', function(snapshot){
                        ...
                        for (var phaseName in $scope.phases){
                            for (var i = 0; i < $scope.nodes.length; i++){
                                if (phaseName.toString() === $scope.nodes[i].phase.toString()){
                                    console.log(phaseName);
                                    console.log($scope.nodes[i]);
                                    console.log($scope.nodes[i].value);
                                    $scope.nodes[i].value = $scope.phases[phaseName];
                                    console.log($scope.nodes[i].value);
                                }
                            }
                        };
                        $scope.sankeyTime($scope.nodes);
                    });
                };
